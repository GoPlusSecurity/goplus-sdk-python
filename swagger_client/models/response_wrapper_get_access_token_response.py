...
class ResponseWrapperGetAccessTokenResponse(object):
    ...
    @property
    def message(self):
        """Gets the message of this ResponseWrapperGetAccessTokenResponse.  # noqa: E501

        Response message  # noqa: E501

        :return: The message of this ResponseWrapperGetAccessTokenResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def message(self, message):
        """Sets the message of this ResponseWrapperGetAccessTokenResponse.
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ResponseWrapperGetAccessTokenResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ResponseWrapperGetAccessTokenResponse):
            return False
