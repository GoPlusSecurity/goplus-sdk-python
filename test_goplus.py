...
class AddressTest(unittest.TestCase):
    def test_address_security(self):
        res = Address().address_security(address="0xc8b759860149542a98a3eb57c14aadf59d6d89b9")
        self.assertEqual(res.code, Code.SUCCESS, res.message)
...
class ApprovalTest(unittest.TestCase):
    ...
    def test_approval_security_v1(self):
        res = Approve().approve_security_v1(chain_id="1", address="0x4639cd8cd52ec1cf2e496a606ce28d8afb1c792f")
        self.assertEqual(res.code, Code.SUCCESS, res.message)

    def test_token_approval_security(self):
        res = Approve().token_approve_security(chain_id="56", address="0xd018e2b543a2669410537f96293590138cacedf3")
        self.assertEqual(res.code, Code.SUCCESS, res.message)

    def test_erc721_approval_security(self):
        res = Approve().erc721_approve_security(chain_id="1", address="0xd95dbdab08a9fed2d71ac9c3028aac40905d8cf3")
        self.assertEqual(res.code, Code.SUCCESS, res.message)

    def test_erc1155_approval_security(self):
        res = Approve().erc1155_approve_security(chain_id="56", address="0xb0dccbb9c4a65a94a41a0165aaea79c8b2fc54ce")
        self.assertEqual(res.code, Code.SUCCESS, res.message)


class DecodeTest(unittest.TestCase):
    def signature_data_decode(self):
...
class NftTest(unittest.TestCase):
    def test_nft_security(self):
        res = Nft().nft_security(chain_id="1", address="0x82f5ef9ddc3d231962ba57a9c2ebb307dc8d26c2")
        self.assertEqual(res.code, Code.SUCCESS, res.message)
